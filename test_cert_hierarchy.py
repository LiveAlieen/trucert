...
def test_certificate_hierarchy():
    ...
    try:
        ...
        print("✓ 自签名证书生成成功")
        print(f"  证书类型: {root_cert_data['type']}")
        print(f"  算法: {root_cert_data['cert_info']['algorithm']}")
        print(f"  是根证书: {'是' if 'parent_signature' not in root_cert_data else '否'}")
        ...
        print("✓ 二级证书生成成功")
        print(f"  证书类型: {secondary_cert_data['type']}")
        print(f"  算法: {secondary_cert_data['cert_info']['algorithm']}")
        print(f"  是根证书: {'是' if 'parent_signature' not in secondary_cert_data else '否'}")
        print(f"  有上级证书签名: {'是' if 'parent_signature' in secondary_cert_data else '否'}")
...
if __name__ == "__main__":
    success = test_certificate_hierarchy()
